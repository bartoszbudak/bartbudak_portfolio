                ...
                <div className="column is-two-thirds" style={{textAlign: 'justify'}}>
                    <div>
                        <ul>
                            ...
                            <br />
                            <li className="resume">
                                 <a className="button is-link is-radiusless" alt="" href="https://drive.google.com/file/d/1iUI431aonn3XOrTC4SmN5zddylBd0Ooy/view?usp=sharing" target="_blank" rel="noopener noreferrer">RESUME</a> 
                            </li>
